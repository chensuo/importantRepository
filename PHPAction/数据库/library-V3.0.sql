...
insert into bookshelves(id , memberId , bookId, createTime) values(生成的UUID , 读者ID , 图书ID , 放入借书架时间);
...
delete from bookshelves where memberId=读者ID and bookId=图书ID
...
delete from bookshelves where memberId=读者ID
