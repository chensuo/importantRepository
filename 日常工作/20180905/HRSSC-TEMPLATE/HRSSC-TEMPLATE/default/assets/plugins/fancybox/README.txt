...
Create your links with a `title` if you want a title to be shown, and add a class:
    ...
    <a href="../../../../assets/plugins/fancybox/large_image.jpg" class="fancybox" title="Sample title"><img src="../../../../assets/plugins/fancybox/small_image.jpg" /></a>

If you have a set of related items that you would like to group,
additionally include a group name in the `rel` (or `data-fancybox-group`) attribute:

    <a href="../../../../assets/plugins/fancybox/large_1.jpg" class="fancybox" rel="gallery" title="Sample title 1"><img src="../../../../assets/plugins/fancybox/small_1.jpg" /></a>
    <a href="../../../../assets/plugins/fancybox/large_2.jpg" class="fancybox" rel="gallery" title="Sample title 1"><img src="../../../../assets/plugins/fancybox/small_2.jpg" /></a>
...
You can specify type directly by adding classname (fancybox.image, fancybox.iframe, etc) or `data-fancybox-type` attribute:
    ...
    //Iframe:
    <a href="../../../../assets/plugins/fancybox/example.html" class="fancybox fancybox.iframe">Example</a>

    //Inline (will display an element with `id="example"`)
    <a href="#example" class="fancybox">Example</a>

    //SWF:
    <a href="../../../../assets/plugins/fancybox/example.swf" class="fancybox">Example</a>

    //Image:
    <a href="../../../../assets/plugins/fancybox/example.jpg" class="fancybox">Example</a>
