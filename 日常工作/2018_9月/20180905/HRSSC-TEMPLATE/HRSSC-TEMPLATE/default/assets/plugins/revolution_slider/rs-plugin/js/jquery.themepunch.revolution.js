	...
	$.fn.extend({
		...
		function createThumbs(container,opt) {
			...
			container.find('>ul:first >li').each(function(i) {
							...
							bullets.append('<div class="bullet thumb"><img src="../../../../../../assets/plugins/revolution_slider/rs-plugin/js/'+src+'"></div>');
			...
			container.find('>ul:first >li').each(function(j) {
				...
				if (li.data('link')!=undefined) {
					...
					if (link=="slide") {
						...
						linktoslide="no";
						li.append('<div class="tp-caption sft slidelink" style="z-index:'+zindex+';" data-x="0" data-y="0" data-linktoslide="'+linktoslide+'" data-start="0"><a target="'+target+'" href="../../../../../../assets/plugins/revolution_slider/rs-plugin/js/'+link+'"><div></div></a></div>');
					}
		...
		function prepareOneSlideV(slotholder,opt,visible) {
				...
				for (var i=0;i<opt.slots+2;i++)
					sh.append('<div class="slot" style="position:absolute;'+
												 ...
												 'left:0px;width:'+w+'px;'+
												 'height:'+h+'px" src="../../../../../../assets/plugins/revolution_slider/rs-plugin/js/'+src+'"></div></div>');
					...
					for (var i=0;i<opt.slots;i++) 	{
						...
						sh.append('<div class="slot" '+
								  ...
								  '<img style="position:absolute;'+
											...
											'height:'+h+'px'+
											'background-color:'+bgcolor+';"'+
								  'src="../../../../../../assets/plugins/revolution_slider/rs-plugin/js/'+src+'"></div></div>');
						y=y+basicsize;
					}
					x=x+basicsize;
				}
