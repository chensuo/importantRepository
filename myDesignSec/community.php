    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="main-container">
            	<!-- 主体 -->
              <div class="page-body">
			    <div class="child-header">社区模块管理<span>Community module management</span></div>
                    ...
                    <div class="modal-content">
                        <form name="frmSec" novalidate>
                            ...
                            <div class="modal-footer">
                                <span class="registe" style="display: none;color:#E10601;width: 64%;text-align: center; ">模块名称不能为空!</span>
                    ...
                    <div class="modal-content">
                        <form name="frmSec" novalidate>
                            ...
                            <div class="modal-body bookCategory-dialog">
                                ...
                                <img src="image/default.jpg" alt="" class="dialog-icon edit-dialog-icon" id="dialog-icon-sec"/>
