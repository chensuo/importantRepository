	...
	<!-- 轮播 -->
	 <div class="ad-wrapper" style="position: relative;z-index: 10">
        <div class="image-wrapper">
	        <a href="news.php?Id=99a0cc1f-205c-11e8-9c83-14dda97c5664"><img src="image/l1.jpg" alt="" title="太阳能发电" /><span>太阳能发电</span><i>Solar power</i></a>
	   		<a href="news.php?Id=65280106-20e5-11e8-8cc7-14dda97c5664"><img src="image/l2.jpg" alt="" title="航空制造"/><span>航空制造</span><i>Aeronautical Manufacturing</i></a>
	        <a href="news.php?Id=8db50ede-20e1-11e8-8cc7-14dda97c5664"><img src="image/l3.jpg" alt="" title="机械制造"/><span>机械制造</span><i>Mechanical manufacture</i></a>
	        <a href="news.php?Id=e7c0a4bb-20e1-11e8-8cc7-14dda97c5664"><img src="image/l4.jpg" alt="" title="发动机制造"/><span>发动机制造</span><i>Engine manufacturing</i></a>
	        <a href="news.php?Id=3e5fbf52-20e4-11e8-8cc7-14dda97c5664"><img src="image/l5.jpg" alt="" title="遥控模型技术"/><span>遥控模型技术</span><i>
Remote control model technology</i></a>
        </div>
    			...
    			<div class="hot-news-item">
    				...
    				<div>
    					<div class="hot-news-title"><a title="<?php echo $item["Title"] ?>" href="news.php?Id=<?php echo $item["Id"] ?>"><?php echo $item["Title"] ?></a><span><?php showTime($item["Time"]) ?></span>
                            <i class="readNumShow">查看量：<?php echo $item["ReadNum"]?></i></div>
